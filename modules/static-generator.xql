...
import module namespace static="http://tei-publisher.com/jinks/static" at "xmldb:exist:///db/apps/jinks/profiles/static/modules/static.xql";
...
declare function sg:generate-static($request as map(*)) {
    array {
        ...
        let $context := map:merge((
            static:prepare($jsonConfig),
            map { "request": map { "parameters": map {} } }
        ))
        return (
